...
if($success){
    ...
    <strong>success</strong> your are successfully signed up.
...
<form action="" method="post">
  ...
  <button type="submit" name="submit" value="submit" class="py-2  rounded-3 text-light mt-2 w-100">sing up</button>
</form>
</div>
